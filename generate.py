...
def _parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="The prompt to use for negative guidance. If not specified, the default negative prompt will be used.",
    )
    parser.add_argument(
        "--use_prompt_extend",
        action="store_true",
...
def generate(args):
    ...
    ####################
    # HACK: Add the negative prompt from the args["negative_prompt"] to cfg["sample_neg_prompt"]
    ####################
    if args.negative_prompt is not None:
        cfg["sample_neg_prompt"] += f" {args.negative_prompt}"
